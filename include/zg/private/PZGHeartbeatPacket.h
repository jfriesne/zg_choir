...
public:
   ...
   uint64 GetSystemNameHash64()  const {return _systemNameHash64;}
...
private:
   ...
   uint64 _systemNameHash64;      // hash-code of our system name, just for sanity checking that we aren't getting crosstalk or random packets
