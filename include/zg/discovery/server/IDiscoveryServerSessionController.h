...
public:
   ...
   /** Called whenever a discovery "ping" Message is received via multicast.
     ...
     * @pingMsg the received "ping" Message, and (on successful return) the "pong" Message to send back.
     * @pingSource the IP address and port that this "ping" Message was sent from (and where
